...
namespace Utils.Configuration
{
    ...
    {
        public SiteConfig()
            : base(PubConstant.SITE_CONFIG_PATH)
        {
        }
        ...
        protected override SiteConfig initConfig()
        {
            var config = new SiteConfig()
            {
                MessageInterval = 10,
                MaxFileSize = 2,
                DefaultAvatar = "/Content/img/male.png",
                DefaultPicture = "/Content/img/male.png",
                SHA1Salt = "YOUANDME",
                ...
                {
                    From = "Johnson@163.com",
                    UserName = "youanme",
                    SMTP = "Johnson.163.com",
                    Port = 25,
                    NickName = "youandme",
                    Password = "youandme",
                    SSL = false,
                ...
                MSMQ = @"FormatName:Direct=TCP:110.10.10.10\private$\",
